\chapter{ΕΡΩΤΗΜΑ 1}
    ...
    \section{ΓΡΑΦΙΚΕΣ ΠΑΡΑΣΤΑΣΕΙΣ}
        ...
        Πέρα από τις προηγούμενες παρατηρήσεις που φαίνονται πιο πρόδηλα, επιπλέον παρατηρούμε μια συμμετρικότητα κοντά στο μηδέν
        για κάθε διάσταση. Επίσης, χρησιμοποιώντας την \texttt{displot()}, μπορούμε να οπτικοποιήσουμε το πώς κατανέμονται οι τιμές:

        \begin{multicols}{2} \centering
            \includegraphics[scale=0.5]{S009_back_distributions}
            \includegraphics[scale=0.5]{S009_thigh_distributions}
        \end{multicols}
        ...
        \begin{multicols}{2} \centering
            \noindent\includegraphics[scale=0.55]{S009_heatmap}
            \includegraphics[scale=0.55]{S015_heatmap}
        \end{multicols}
