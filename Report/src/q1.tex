\chapter{ΕΡΩΤΗΜΑ 1}
    ...
    \section{ΓΡΑΦΙΚΕΣ ΠΑΡΑΣΤΑΣΕΙΣ}
        ...
        \begin{multicols}{2} \centering
            \noindent\includegraphics[scale=0.55]{img/distributions/S015_back_subplots}
            \includegraphics[scale=0.55]{img/distributions/S015_thigh_subplots}
        \end{multicols}
        ...
        \pagebreak
        \begin{multicols}{2} \centering
            \noindent\includegraphics[scale=0.55]{img/distributions/S027_back_subplots}
            \includegraphics[scale=0.55]{img/distributions/S027_thigh_subplots}
        \end{multicols}
